...
//Mercado Pago
    [
        'key'    => 'sales.payment_methods.mercado_pago',  // Clave única para Mercado Pago
        'name'   => 'Mercado Pago',  // Nombre del método de pago que aparecerá en la interfaz de administración
        'sort'   => 4,  // Orden en el que aparece el método de pago en el listado
        'fields' => [
            [
                'name'          => 'title',
                'title'         => 'Título',  // Título que se muestra en el formulario de pago
                'type'          => 'text',
                'validation'    => 'required',
                'channel_based' => false,
                'locale_based'  => true,
                ...
                'name'          => 'description',
                'title'         => 'Descripción',  // Descripción que se muestra en el formulario de pago
                'type'          => 'textarea',
                'channel_based' => false,
                'locale_based'  => true,
            ], [
                'name'          => 'active',
                'title'         => 'Estado',  // Define si el método de pago está habilitado o no
                'type'          => 'boolean',
                'validation'    => 'required',
                'channel_based' => false,
                'locale_based'  => true,
                ...
                'name'          => 'sandbox',
                'title'         => 'Modo de prueba',  // Activa o desactiva el modo sandbox (pruebas)
                'type'          => 'boolean',
                'validation'    => 'required',
                'channel_based' => false,
                'locale_based'  => true,
